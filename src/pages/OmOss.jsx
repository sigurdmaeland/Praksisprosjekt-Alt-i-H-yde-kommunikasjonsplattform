  ...
  const teamMembers = [
    {
      ...
      image: "/sigurd.png", // Du må legge til dette bildet i public mappen
      ...
      <div className="content-wrapper">
        <div className="omoss-header">
          ...
          <p className="omoss-subtitle">
            Vi er tre studenter fra <a href="https://www.uia.no" target="_blank" rel="noopener noreferrer" style={{color: '#2C5282', textDecoration: 'none', fontWeight: '600'}}>Universitetet i Agder (UiA)</a> som 
            studerer IT og Informasjonssystemer. Vi har blitt så heldige å få muligheten til å samarbeide med <a href="https://www.altihoyde.no" target="_blank" rel="noopener noreferrer" style={{color: '#E6A639', textDecoration: 'none', fontWeight: '600'}}>Alt i Høyde AS</a> om 
            et spennende praksisprosjekt hvor vi skal utvikle en helt ny, moderne nettside for bedriften. 
          </p>
        </div>
